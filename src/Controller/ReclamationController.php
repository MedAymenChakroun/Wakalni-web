...
class ReclamationController extends AbstractController
{
     ...
     */
    public function new(Request $request, EntityManagerInterface $entityManager,$id, CommandeRepository $repository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $reclamation->setCommandeid($commande);
            $reclamation->setClientid($commande->getClientid());
